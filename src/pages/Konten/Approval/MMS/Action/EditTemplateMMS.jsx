...
import { Form, Input, Button, Descriptions, Select, Tooltip, Spin } from "antd";
...
const EditTemplateMMS = () => {
  ...
  useEffect(() => {}, [namaTemplate, kategori, kontenTemplate]);
  ...
  return (
    <div className="mt-5">
      <div>
        ...
        <div className="text-center text-2xl">Edit Template MMS</div>
      </div>
          ...
          >
            ...
            >
              <Input
                ...
                defaultValue={data?.mmsNameTemplate}
              />
            </Form.Item>
            <Form.Item
            ...
            >
              <Select
                ...
                defaultValue={data?.mmsCategoryTemplate}
            ...
            >
              <Input.TextArea
                ...
                defaultValue={data?.kontenTemplate}
              />
            </Form.Item>
...
export default EditTemplateMMS;
